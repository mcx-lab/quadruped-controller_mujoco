...
void LinearKFPositionVelocityEstimator<T>::print_estimate()
{
  //DEBUG
    ...
    pretty_print(this->_stateEstimatorData.result->position, std::cout, "position"); //orientation
    pretty_print(this->_stateEstimatorData.result->vBody, std::cout, "vBody"); //rpy
}
