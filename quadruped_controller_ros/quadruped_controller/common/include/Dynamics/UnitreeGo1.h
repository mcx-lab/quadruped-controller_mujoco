...
Quadruped<T> buildGo1() {
  std::cout << "building go1\n";
  Quadruped<T> quadruped;
  quadruped._robotType = RobotType::UNITREE_GO1;

  quadruped._bodyMass = 5.204 + 8 * 0.08;
  quadruped._bodyLength = 0.1881 * 2;
  quadruped._bodyWidth = 0.04675 * 2;
  quadruped._bodyHeight = 0.114;
  quadruped._abadGearRatio = 6;
  quadruped._hipGearRatio = 6;
  quadruped._kneeGearRatio = 9.33;
  quadruped._abadLinkLength = 0.08;
  quadruped._hipLinkLength = 0.213;
  ...
  quadruped._kneeLinkLength = 0.213;
  quadruped._maxLegLength = 0.426;
  ...
  // locations
  quadruped._abadRotorLocation = Vec3<T>(0.112, 0.047, 0);
