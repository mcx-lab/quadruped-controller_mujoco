...
Quadruped<T> buildAliengo() {
  printf("building Aliengo\n");
  Quadruped<T> quadruped;
  quadruped._robotType = RobotType::UNITREE_ALIENGO;

  quadruped._bodyMass = 11.041; // 9.041
