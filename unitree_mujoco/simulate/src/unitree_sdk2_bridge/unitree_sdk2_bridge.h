...
{
public:
    UnitreeSdk2Bridge(mjModel *model, mjData *data,ros::NodeHandle &nh);
    ~UnitreeSdk2Bridge();

    void LowCmdGoHandler(const unitree_legged_msgs::LowCmd::ConstPtr& msg);
